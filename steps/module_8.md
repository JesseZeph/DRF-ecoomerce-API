...
> This retrieves the auth token for **yourUsername**

curl -X POST -F 'username=**yourUsername**' -F 'password=**yourPassword**' http://api:8000/api-token-auth/

http post http://api:8000/api-token-auth/ username=**yourUsername** password=**yourPassword**


> This will retrieve all items

curl -X GET -H 'Authorization: Token 50fa9974025252343cb1878d25e843ae08a2de6f' http://api:8000/item/

http http://api:8000/item/ 'Authorization: Token **usertoken**'


> This will retreive a single item

curl -X GET -H 'Authorization: Token 50fa9974025252343cb1878d25e843ae08a2de6f' http://api:8000/item/0d979e35-7b30-4cdb-b48d-542476743f06/

http http://api:8000/item/0d979e35-7b30-4cdb-b48d-542476743f06/ 'Authorization: Token 50fa9974025252343cb1878d25e843ae08a2de6f' 

> This retrieve all orders

curl -X GET -H 'Authorization: Token 50fa9974025252343cb1878d25e843ae08a2de6f' http://api:8000/order/

http http://api:8000/order/ 'Authorization: Token 50fa9974025252343cb1878d25e843ae08a2de6f'

> This will place an order for item id = 0d979e35-7b30-4cdb-b48d-542476743f06 quantity = 1

curl -X POST -H 'Content-Type: application/json' -H 'Authorization: Token 50fa9974025252343cb1878d25e843ae08a2de6f' -d '{"item": "0d979e35-7b30-4cdb-b48d-542476743f06", "quantity": "1"}' http://api:8000/order/

http http://api:8000/order/ 'Authorization: Token 50fa9974025252343cb1878d25e843ae08a2de6f' item="0d979e35-7b30-4cdb-b48d-542476743f06" quantity="1"


> This get order id = **your_order_uuid**

curl -X GET -H 'Authorization: Token 50fa9974025252343cb1878d25e843ae08a2de6f' http://api:8000/order/**your_order_uuid**/

http http://api:8000/order/**your_order_uuid**/ 'Authorization: Token 50fa9974025252343cb1878d25e843ae08a2de6f'
